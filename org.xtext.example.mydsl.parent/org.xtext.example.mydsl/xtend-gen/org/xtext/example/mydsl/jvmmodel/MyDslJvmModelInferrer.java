...
public class MyDslJvmModelInferrer extends AbstractModelInferrer {
  ...
  protected void _infer(final Entity entity, @Extension final IJvmDeclaredTypeAcceptor acceptor, final boolean prelinkingPhase) {
    ...
    String _plus = (_fullyQualifiedName + "Impl");
    final Procedure1<JvmGenericType> _function_1 = (JvmGenericType it) -> {
      EList<Adapter> _eAdapters = it.eAdapters();
      OutputConfigurationAdapter _outputConfigurationAdapter = new OutputConfigurationAdapter(MyOutputConfigProvider.GEN_ONCE);
      _eAdapters.add(_outputConfigurationAdapter);
      EList<JvmTypeReference> _superTypes = it.getSuperTypes();
      JvmTypeReference _typeRef = this._typeReferenceBuilder.typeRef(this._iQualifiedNameProvider.getFullyQualifiedName(entity).toString());
      this._jvmTypesBuilder.<JvmTypeReference>operator_add(_superTypes, _typeRef);
      EList<JvmMember> _members = it.getMembers();
      JvmField _field = this._jvmTypesBuilder.toField(entity, "dummy", this._typeReferenceBuilder.typeRef(String.class));
      this._jvmTypesBuilder.<JvmField>operator_add(_members, _field);
    };
    acceptor.<JvmGenericType>accept(this._jvmTypesBuilder.toClass(entity, _plus), _function_1);
  }
