...
class MyDslJvmModelInferrer extends AbstractModelInferrer {
	...
	def dispatch infer(Entity entity, extension IJvmDeclaredTypeAcceptor acceptor, boolean prelinkingPhase) {
		...
		acceptor.accept(entity.toClass( entity.fullyQualifiedName + "Impl" ))[
			eAdapters.add(new OutputConfigurationAdapter(MyOutputConfigProvider.GEN_ONCE))
			superTypes += entity.fullyQualifiedName.toString.typeRef
			members += entity.toField("dummy", String.typeRef)
		]
	}
}
